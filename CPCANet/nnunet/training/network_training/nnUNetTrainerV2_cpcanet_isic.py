...
from nnunet.network_architecture.CPCANet import CPCANet
...
class nnUNetTrainerV2_cpcanet_isic(nnUNetTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        assert self.model_size in ['Base'], "error key words, or you can dismiss it and set it by yourself"
    ...
    def initialize_network(self):   
        # Don't touch conv_op
        self.network = CPCANet(self.config, 
