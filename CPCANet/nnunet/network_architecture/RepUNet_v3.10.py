...
from nnunet.network_configuration.config_v3 import CONFIGS
...
class unet2022(SegmentationNetwork):
    def __init__(self, 
        ...
        self.hs = config.hyper_parameter.hs
        self.ws = config.hyper_parameter.ws
        self.sharesets_nums = config.hyper_parameter.sharesets_nums
        self.reparam_conv_k = config.hyper_parameter.reparam_conv_k
...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        config = CONFIGS['ACDC_rep224']
        model = unet2022(config,
                                1, 
                                96,
                                [6,12,24,48], 
                                4, 
